...
<main class="mx-auto w-[80%] max-w-[560px] mb-10 page-reveal">

  <h1 class="mt-[50px] lg:mt-[100px] font-medium">Ishtiaq Dishan</h1>
  <p class="opacity-50">Updated 16 Jul 2026</p>

  <p class="mt-10">I'm a full-stack web developer from Sirajganj, Bangladesh, and a Class 12 student. I love building small, polished products that are simple, useful, and enjoyable to use.</p>

  <p class="mt-10">I've built products like <a href="https://www.studify.sbs/"><span class="link">Studify</span></a> and <a href="https://www.bdsaaszone.site/"><span class="link">BD SaaS Zone</span></a>, and I'm currently working on <a href="https://github.com/dishan1223/mutt"><span class="link">Mutt</span></a>, an open-source project. I'm always excited to build useful and enjoyable software while exploring new tools, technologies, and ideas. Beyond coding, I enjoy connecting with experienced developers, learning from their insights, and continuously improving my craft.</p>

  <p class="mt-10">Feel free to say hi on <a href="https://github.com/dishan1223"><span class="link">GitHub</span></a>, <a href="https://x.com/ishtiaqdishan"><span class="link">X</span></a>, <a href="https://www.facebook.com/ishtiaq.dishan"><span class="link">Facebook</span></a>, or <a href="mailto:dishanishtiaq45@gmail.com"><span class="link">email</span></a> if you'd like to connect.</p>

  <Devider />
  <h1 class="mt-10 opacity-50">Tech Stack</h1>
  ...
  <Devider />
  <h1 class="mt-10 opacity-50">Work</h1>
  {#each works as w}
    <WorkItem year={w.year} items={w.items} />
  {/each}

  <Devider />
  <p class="mt-10">{time} <span class="opacity-50">in Sirajganj, Bangladesh</span></p>
</main>